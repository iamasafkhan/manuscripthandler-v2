        ...
        <section class="inner-page">
            <div class="container">
                <div class="row">
                    ...
                    @endif
                    <div class="col-lg-8">
                        <form class="" name="frmRegister" id="frmRegister" action="">
                            <div class="row mb-4">
                                <div class="col-md-3">
                                    <label class="form-label" for="prefix">Prefix</label>
                                    <select name="prefix" id="prefix" class="form-control @error('prefix') is-invalid  @enderror" required>
                            ...
                            <div class="row">
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="email" name="primaryEmailAddress" id="primaryEmailAddress"
                                       placeholder="Primary Email Address" required class="form-control @error('email') is-invalid  @enderror" />
                                       @error('email')
                                       <span class="invalid-feedback"> {{ $message }}</span>
                                      @enderror
                                 </div>
                            ...
                            <div class="row">
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="password" name="cpassword" id="cpassword"
                                        placeholder="Confirm Password" required class="form-control @error('cpassword') is-invalid  @enderror">
                                </div>
                            </div>
