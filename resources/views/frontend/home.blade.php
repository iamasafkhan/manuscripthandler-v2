...
@section('content')
        ...
        <div class="container" data-aos="fade-up">
            <div class="row gx-0">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up"
                    ...
                    <div class="content">
                        <h3>Who We Are</h3>
                        <h2>The MH is functionally integrated to provide solutions from a manuscript submission to
                            final publications, all in one place.</h2>
                        <p>
                            A single package of MH will provide individual panel for Authors, Reviewers, Editors,
                            Associate Editors, Editorial Office and Publishers. Each of these individuals will be
                            able to handle all their tasks independently and/or integrated manners, whatever and
                            wherever are needed. Each panel is supported with supportive resources in both detailed
                            and integrated PDFs and in audio-video tutorials. You can perform any role without prior
                            logging out from one role in any journal (provided that you have been given permission
    ...
    <section id="values" class="values">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <p class="text-center">In addition to working station for manuscript handling, we provide following
                outstanding features with no additional cost:</p>
