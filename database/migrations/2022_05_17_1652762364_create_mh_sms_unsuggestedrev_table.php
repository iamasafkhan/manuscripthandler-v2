...
class CreateMhSmsUnsuggestedrevTable extends Migration
{
    public function up()
    {
        Schema::create('mh_sms_unsuggestedrev', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mh_sms_unsuggestedrev');
    }
}